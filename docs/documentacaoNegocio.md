...
![Fluxo de Atendimento](./imgs/fluxoAtendimento.png)

* **Fluxo de atendimento (via Pacote):**

![Fluxo de Atendimento](./imgs/fluxoAtendimento02.png)

* **Fluxo de pacotes mensais:**

![Fluxo de Atendimento](./imgs/fluxoAtendimento03.png)
...
![Modelo Entidade-Relacionamento](./imgs/relacionamentos.png)
...
![Tela Home](./imgs/telaHome.png)

**Página: Gestão de clientes | Dados de clientes**

![Tela Gestão de Clientes - Dados dos Clientes](./imgs/telaGestaoClientesDadosClientes.png)

**Página: Gestão de clientes | Dados dos animais dos clientes**

![Tela Gestão de Clientes - Dados dos Animais](./imgs/telaGestaoClientesPetsdoCliente.png)

**Página: Gestão de clientes | Histórico de agendamentos**

![Tela Gestão de Clientes - Histórico de agendamentos](./imgs/telaGestaoClientesHistoricoAgendamentos.png)

**Página: Gestão de Pacotes | Cadastro**

![Tela Gestão de Pacotes - Cadastro](./imgs/telaGestaoPacotesCadastroPacotes.png)

**Página: Gestão de Serviços | Cadastro**

![Tela Gestão de Serviços - Cadastro](./imgs/telaGestaoServicosCadastroServicos.png)

**Página: Gestão de agenda | Cadastro de atendimentos**

![Tela Gestão de Agenda - Cadastro de Atendimentos](./imgs/telaGestaoAgendaCadastroAtendimentos.png)

**Página: Gestão do Financeiro | Controle de caixa**

![Tela Gestão do Financeiro - Controle de Caixa](./imgs/telaGestaoFinanceiroControleCaixa.png)

**Página: Gestão de relatórios**

![Tela Gestão de Relatórios](./imgs/telaGestaoRelatorios01.png)
![Tela Gestão de Relatórios](./imgs/telaGestaoRelatorios02.png)
